                    ...
                    <div class="search_advanced row rounded shadow p-4 ">
                        <div class="col-12">
                            ...
                            <form action="{{ route('timkiem_baidang') }}" method="get">
                                ...
                                <div class="form-group">
                                    <label for="">
                                        <input type="text" id="bankinh" readonly style="border: none;">
                                        <input type="text" name="bankinh" hidden id="get_bankinh"
                                            value="{{ Request::get('bankinh') != '' ? Request::get('bankinh') : '500' }}">
                                    </label>
                                ...
                                <div class="form-group">
                                    <select id="type" class="form-control" name="type">
                                        <option disable selected hidden value="tatca">Hình thức</option>
                                        <option value="thue" {{ Request::get('type') === 'thue' ? 'selected' : '' }}>Cho
                                            Thuê</option>
                                        <option value="ban" {{ Request::get('type') === 'ban' ? 'selected' : '' }}>Rao Bán
                                        </option>
                                ...
                                <div class="form-group">
                                    <select id="loai_id" class="form-control" name="loai_id">
                                        <option disable selected hidden value="tatca">Loại</option>
                                ...
                                <div class="form-group">
                                    <select id="huong" class="form-control" name="huong">
                                        <option disable selected hidden value="tatca">Hướng nhà</option>
                                        <option value="Dong" {{ Request::get('huong') == 'Dong' ? 'selected' : '' }}>
                                            Hướng nhà: Đông</option>
                                        ...
                                        <option value="Dong Bac"
                                            ...
                                            Hướng nhà: Đông Bắc</option>
                                        <option value="Dong Nam"
                                            {{ Request::get('huong') == 'Dong Nam' ? 'selected' : '' }}>
                                            Hướng nhà: Đông Nam</option>
                                        <option value="Tay Bac" {{ Request::get('huong') == 'Tay Bac' ? 'selected' : '' }}>
                                            Hướng nhà: Tây Bắc</option>
                                        <option value="Tay Nam" {{ Request::get('huong') == 'Tay Nam' ? 'selected' : '' }}>
                                            Hướng nhà: Tây Nam</option>
                                        <option value="tatca">Tất Cả</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <select id="sophongngu" class="form-control" name="sophongngu">
                                        <option disable selected hidden value="tatca">Số phòng ngủ</option>
                                ...
                                <div class="form-group">
                                    <select id="sophongtam" class="form-control" name="sophongtam">
                                        <option disable selected hidden value="tatca">Số phòng tắm</option>
                                ...
                                <div class="form-group slider_2_gia">
                                    <label for="">
                                        ...
                                        <input type="text" name="gia1" id="get_gia_1"
                                            value="{{ Request::get('gia1') != '' ? Request::get('gia1') : '' }}" hidden>
                                        <input type="text" name="gia2" id="get_gia_2"
                                            value="{{ Request::get('gia2') != '' ? Request::get('gia2') : '' }}" hidden>
                                    </label>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mota-new-post">
                                                            ...
                                                            <div class="tiennghi mt-1" style="font-size: 13px">
                                                                <span class="pr-1">Ngủ: {{ $baidang->sophongtam }}</span>
                                                                <span class="pr-1">Tắm: {{ $baidang->sophongngu }}</span>
                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <select name="sort" id="sort" class="form-control w-50"
                                        ...
                                        <option value="{{ route('timkiem_baidang', [
                                                ...
                                                'sort' => request('sort'),
                                                'sortByGia' => 'asc',
                                            ]) }}" {{ Request::get('sortByGia') === 'asc' ? 'selected' : '' }}>Giá tăng dần
                                        </option>
                                        <option value="{{ route('timkiem_baidang', [
                                                'type' => request('type'),
                                                'keyword' => request('keyword'),
                        ...
                        <div class="row">
                                                ...
                                                <div class="khung shadow-sm" style="height: 450px">
                                                    <div id="baidang_{{ $baidang->id }}" class="carousel slide"
                                                        ...
                                                        <ol class="carousel-indicators">
                                                            <li data-target="#baidang_{{ $baidang->id }}" data-slide-to="0"
                                                                class="active">
                                                            </li>
                                                            <li data-target="#baidang_{{ $baidang->id }}" data-slide-to="1">
                                                            </li>
                                                            <li data-target="#baidang_{{ $baidang->id }}" data-slide-to="2">
                                                            </li>
                                                        </ol>
                                                        <div class="slide">
                                                            <div class="carousel-inner">
                                                                <div class="carousel-item
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                active"
                                                                    data-interval="2000">
                                                                    <img src="img/slide/slide1/h1.jpg"
                                                                        class="d-block w-100 lazy" alt="...">
                                                                </div>
                                                                <div class="carousel-item" data-interval="2000">
                                                                    <img src="img/slide/slide1/h2.jpg"
                                                                        class="d-block w-100 lazy" alt="...">
                                                                </div>
                                                                <div class="carousel-item" data-interval="2000">
                                                                    <img src="img/slide/slide1/h3.jpg"
                                                                        class="d-block w-100 lazy" alt="...">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="noibat px-2 {{ $baidang->isChoThue ? 'ml-1' : '' }}">
                                                            Nổi bật
                                                        </div>
                                                        <a class="carousel-control-prev" href="#baidang_{{ $baidang->id }}"
                                                            role="button" data-slide="prev">
                                                            <span class="carousel-control-prev-icon"
                                                                aria-hidden="true"></span>
                                                            <span class="sr-only">Previous</span>
                                                        </a>
                                                        <a class="carousel-control-next" href="#baidang_{{ $baidang->id }}"
                            ...
                            @else
                                <div class="text-center w-100">
                                    <hr>
                                    <p class="font-weight-bold">Hiện tại hệ thống không tìm thấy bài đăng nào phù hợp với
                                        yêu cầu của
                                        bạn. Vui lòng đăng ký nhận tin để nhận được thông báo mới nhất nếu phù hợp với yêu
                                        cầu của bạn.
                                        <br>
                                        Xin cảm ơn.
                                        <br>
