            ...
            <div class="container py-lg-4 py-md-3 py-2">
                ...
                <div class="blo-singl mb-4">
                    <ul class="blog-single-author-date align-items-center">
                        ...
                        <li><span class="fa fa-share-square-o"></span> </sup> sqrft : {{ $baidang->dientich }}m<sup>2 </li>
                    </ul>
                    <ul class="share-post">
                        ...
                        <div class="blog-single-post">
                            <div class="single-post-image mb-5">
                                <div class="owl-blog owl-carousel owl-theme">
                                    ...
                                    @foreach (explode(',', $baidang->hinhanh) as $item)
                                        <div class="item">
                                            <div class="card">
                                                <img src="{{ asset('images/' . $item) }}" class="img-fluid radius-image"
                                                    alt="image">
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <div class="agent-map">
                                    ...
                                    <div style="width: 100%">
                                        <iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0"
                                            marginwidth="0"
                                            src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q={{ $baidang->toadoX }},{{ $baidang->toadoY }} &amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                                    </div>
                                    <p>{{ $baidang->diachi }}</p>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-side col-lg-4 col-md-12 col-sm-12 mt-lg-0 mt-5">
                        <aside class="sidebar">
                            ...
                            <div class="sidebar-widget popular-posts">
                                ...
                                <article class="post">
                                    <figure class="post-thumb"><img src="{{ asset('img/images/l5.jpg') }}"
                                            class="radius-image" alt="">
                                    </figure>
                                    <div class="text mb-0"><a href="#blog-single">Liên hệ người bán
                                        </a>
                                        <div class="post-info">{{ $user->sdt }}</div>
                                        <div class="text"><a href="#blog-single">{{ $user->name }}</a>
                                        </div>
                                </article>
                            ...
                            <form class="" action="{{ route('binhluan.store') }}" method="POST">
                                ...
                                <div class="sidebar-widget popular-posts ">
                                    ...
                                    <textarea class="form-control" name="noidung_bl" id="binhluan" rows="1"
                                        ...
                                        @if(Auth::guest())
                                        <a href="{{route('login')}}" class="btn btn-primary btn-style mt-4">Đăng nhập để bình luận</a>
                                        @else
                                        <button type="submit" name="btnbinhluan" class="btn btn-primary btn-style mt-4">Bình
                                            luận</button>
                                        @endif
